...
const Header = () => {
    ...
    return (
        <header className={`transition-all duration-150 flex flex-row-reverse md:flex-row ${!scroll ? 'lg:text-white' : 'text-gray-600 md:bg-gray-50 md:shadow-md'}  fixed top-0 inset-x-0  h-16 items-center justify-between px-4 md:px-8 z-50`}>
            <div>
            ...
            <div 
                ...
                <nav className='w-full flex-col space-y-4 md:space-y-0 md:flex-row flex justify-evenly items-center md:space-x-8'>
                    ...
                    <LinkItem content='Experience' link="ExperienceSection"/>
            ...
            <div className="bg-white rounded-full p-2 shadow-lg md:hidden">
                <Icon onClick={handleToggle} icon={ !toggle ? menuAlt2 : closeFill} className='text-3xl text-blue-500 cursor-pointer active:scale-100'/>
            </div>
        </header>
    );
}
